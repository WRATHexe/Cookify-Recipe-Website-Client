      ...
      <nav className="grid grid-flow-col gap-6">
        {["About us", "Contact", "Jobs", "Press kit"].map((item) => (
          <a
            key={item}
            href="#"
            className="link text-slate-700 hover:text-emerald-600 font-medium transition"
          >
            {item}
          </a>
        ))}
      ...
      <nav>
        <div className="grid grid-flow-col gap-6">
          ...
          <a
            ...
            aria-label="Twitter"
            className="fill-slate-600 hover:fill-blue-500 transition"
          >
            <svg
          ...
          <a
            ...
            aria-label="YouTube"
            className="fill-slate-600 hover:fill-red-600 transition"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="28"
          ...
          <a
            ...
            aria-label="Facebook"
            className="fill-slate-600 hover:fill-blue-400 transition"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="28"
